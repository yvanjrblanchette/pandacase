					...
					<div className="grid gap-4 sm:grid-cols-2">
						<Card>
							<CardHeader className="pb-2">
								<CardDescription>Dernière Semaine</CardDescription>
								<CardTitle className="text-4xl">{formatPrice(lastWeekSum._sum.amount ?? 0)}</CardTitle>
							</CardHeader>
							<CardContent>
								<div className="text-sm text-muted-foreground">Objectif de {formatPrice(WEEKLY_GOAL)}</div>
							</CardContent>
							<CardFooter>
						...
						<Card>
							<CardHeader className="pb-2">
								<CardDescription>Dernier Mois</CardDescription>
								<CardTitle className="text-4xl">{formatPrice(lastMonthSum._sum.amount ?? 0)}</CardTitle>
							</CardHeader>
							<CardContent>
								<div className="text-sm text-muted-foreground">Objectif de {formatPrice(MONTHLY_GOAL)}</div>
							</CardContent>
							<CardFooter>
					...
					<Table>
						<TableHeader>
							<TableRow>
								...
								<TableHead className="hidden sm:table-cell">Date de commande</TableHead>
